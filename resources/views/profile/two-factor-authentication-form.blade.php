    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                ...
                @if ($showingConfirmation)
                    <div class="mt-4">
                        ...
                        <x-input id="code" type="text" name="code" class="form-input block mt-1 w-1/2" inputmode="numeric" autofocus autocomplete="off"
                            wire:model="code"
            ...
            @if ($showingRecoveryCodes)
                ...
                <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 dark:bg-dark-eval-2 dark:text-gray-100 rounded-lg">
